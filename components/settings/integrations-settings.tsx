...
export function IntegrationsSettings() {
  const [calendly, setCalendly] = useState<CalendlyStatus>({
    connected: false,
  });
    ...
    <div className="space-y-6">
          ...
          <div className="border-t border-gray-100 px-6 py-4 bg-gray-50">
            ...
            <ul className="space-y-1.5 text-sm text-gray-600">
              <li className="flex items-start gap-2">
                <span className="w-4 h-4 rounded-full bg-blue-100 text-blue-600 text-xs flex items-center justify-center flex-shrink-0 mt-0.5">
                  1
                </span>
      ...
      <div className="bg-white rounded-xl border border-gray-200 p-6">
        ...
        <p className="text-sm text-gray-500 mb-3">
          To automatically sync appointment cancellations and reschedules, add
          this webhook URL in your Calendly developer settings:
        </p>
        ...
        <p className="text-xs text-gray-400 mt-2">
          Subscribe to:{" "}
          <code className="bg-gray-100 px-1 rounded">invitee.created</code>,{" "}
          <code className="bg-gray-100 px-1 rounded">invitee.canceled</code>,{" "}
