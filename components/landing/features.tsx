...
const features = [
  {
    ...
    description:
      "Complete patient profiles with treatment history, notes, and automated follow-ups.",
  ...
  },
  {
    ...
    description:
      "Intelligent appointment booking with automated reminders and waitlist management.",
  ...
  },
  {
    ...
    description:
      "Real-time insights into revenue, patient retention, and treatment acceptance rates.",
  ...
  },
  {
    ...
    description:
      "Automated SMS, email campaigns, and review requests to keep patients engaged.",
  ...
  },
  {
    ...
    description:
      "Visual treatment plans with integrated payment options and financing.",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Smile Pro combines all the tools dental practices need into one
            seamless platform — no more juggling multiple systems.
          </p>
        </div>
