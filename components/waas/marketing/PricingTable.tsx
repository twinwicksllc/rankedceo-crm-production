...
const TIER_ORDER: WaasPackageTier[] = [
  "hosting",
  "hosting_only",
  "standard",
  "premium",
...
const FEATURE_ROWS: {
  label: string;
  tiers: Partial<Record<WaasPackageTier, string | boolean>>;
}[] = [
  {
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-slate-500 max-w-2xl mx-auto">
            From free hosting to a full AI-powered marketing suite — pick the
            plan that fits your business today, upgrade anytime.
          </p>
              ...
              >
                  ...
                  {(tier === "standard" || tier === "premium") &&
                    interval === "year" && (
                      <p className="mt-1 text-xs text-emerald-600 font-medium">
                        Save ${plan.monthlyPrice * 12 - plan.yearlyPrice}/yr vs
                        monthly
                      </p>
                    )}
                </div>
                ...
                <Link
                  href={
                    isFree
                      ? "/get-started"
                      : `/get-started?plan=${tier}&interval=${isAnnualOnly ? "year" : interval}`
                  }
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="bg-slate-50 border-b border-slate-200">
                <th className="text-left py-4 px-6 font-semibold text-slate-600 w-1/3">
                  Feature
                </th>
                {TIER_ORDER.map((tier) => (
                  <th
                    key={tier}
                    className="py-4 px-4 font-semibold text-slate-700 text-center"
                  >
          ...
          {[
            {
              icon: "🔒",
              title: "No contracts",
              body: "Cancel or switch plans anytime. No hidden fees.",
            },
            {
              icon: "⚡",
              title: "Live in 48 hours",
              body: "We build and launch your AI-generated site in 2 business days.",
            },
            {
              icon: "🤝",
              title: "White-glove onboarding",
              body: "Every plan includes a setup call with your dedicated account team.",
            },
          ].map(({ icon, title, body }) => (
        ...
        <div className="mt-16 text-center bg-gradient-to-br from-blue-600 to-blue-800 rounded-3xl py-12 px-8 shadow-xl">
          ...
          <p className="text-blue-100 mb-8 max-w-lg mx-auto">
            Run a free AI audit of your current website — we&apos;ll recommend
            the best plan based on your actual SEO gaps and growth goals.
          </p>
          <Link
            href="/get-started"
