...
const DEFAULT_BADGES = [
  {
    ...
    sub: "Fully certified professionals",
  },
  ...
  { icon: "🏆", label: "Award-Winning", sub: "Best in the area" },
  {
    ...
    sub: "100% satisfaction or we fix it",
  },
];
...
export function TrustBar({
  ...
  const businessName =
    tenant.brand_config.business_name ?? tenant.legal_name ?? "We";
      ...
      >
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            ...
            {content?.subheadline && (
              <p className="text-white/70 text-base max-w-2xl mx-auto mb-4">
                {content.subheadline}
              </p>
            )}
            {auditData && (
              <p className="text-white/70 text-lg max-w-2xl mx-auto">
                ...
                means customers find us first — and our reviews keep them coming
                back.
              </p>
            )}
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {badges.map(({ icon, label, sub }) => (
              ...
              >
                ...
                <div>
                  <h3 className="font-brand-heading font-bold text-white text-lg">
                    {label}
                  </h3>
                  <p className="font-brand-body text-white/70 text-sm mt-1">
                    {sub}
                  </p>
                </div>
              </div>
            ...
            <div className="mt-12 pt-12 border-t border-white/20 grid grid-cols-2 sm:grid-cols-4 gap-6 text-center">
              {[
                ...
                <div key={label}>
                  ...
                  <div className="text-white/60 text-sm mt-1 font-brand-body">
                    {label}
                  </div>
                </div>
              ))}
            ...
            >
              ...
              <div className="text-left">
                ...
                <div className="font-brand-body text-sm opacity-70">
                  SEO Score: {auditData.overall_score}/100 — Outranking local
                  competitors
                </div>
              </div>
            </div>
