...
export function AboutSection({ tenant, content }: AboutSectionProps) {
  ...
  const businessName =
    brandConfig.business_name ?? tenant.legal_name ?? "Our Team";
  const onboardingContent = (brandConfig as unknown as Record<string, unknown>)
    .content as Record<string, unknown> | undefined;
  const fallbackBody =
    typeof onboardingContent?.about_narrative === "string"
  ...
  return (
    ...
    >
      <div className="max-w-5xl mx-auto">
        ...
        <h2
          className="font-brand-heading text-3xl sm:text-4xl font-bold mb-5"
        ...
        <p
          className="font-brand-body text-lg leading-relaxed mb-8"
