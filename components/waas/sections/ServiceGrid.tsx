...
export function ServiceGrid({ tenant, config, content }: ServiceGridProps) {
  ...
  const businessName =
    tenant.brand_config.business_name ?? tenant.legal_name ?? "Our Team";
    ...
    >
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-14">
          ...
          >
            {content?.subheadline ??
              "From routine maintenance to emergency calls, we handle it all with expert care and transparent pricing."}
          </p>
        </div>
