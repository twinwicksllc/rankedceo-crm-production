      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          >
            ...
            >
              <li className="flex items-center gap-2">
                <span className="text-green-500">✓</span> 0% APR promotional
                periods
              </li>
              <li className="flex items-center gap-2">
                <span className="text-green-500">✓</span> Fast approval
                decisions
              </li>
              <li className="flex items-center gap-2">
                <span className="text-green-500">✓</span> No prepayment
                penalties
              </li>
              <li className="flex items-center gap-2">
                <span className="text-green-500">✓</span> Flexible monthly
                payments
              </li>
            </ul>
            <a
          ...
          >
            ...
            >
              <li className="flex items-center gap-2">
                <span className="text-green-500">✓</span> Transparent, flat-rate
                pricing
              </li>
              <li className="flex items-center gap-2">
        ...
        >
          Subject to credit approval. Terms and conditions apply. Contact us for
