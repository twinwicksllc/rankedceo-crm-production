    ...
    >
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
        ...
        <p
          ...
          style={{ color: hasHeroImage ? 'rgba(255,255,255,0.85)' : 'var(--brand-text)', opacity: hasHeroImage ? 1 : 0.7 }}
        >
          {subheadline}
        </p>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          {calendlyUrl ? (
            <a
              ...
              style={{ backgroundColor: hasHeroImage ? 'rgba(255,255,255,0.2)' : 'var(--brand-primary)', border: hasHeroImage ? '2px solid white' : 'none' }}
            >
              📅 {content?.primaryCtaLabel ?? 'Book a Free Estimate'}
            </a>
          ) : null}
          {phone && (
            <a
              ...
              style={{
                ...
                backgroundColor: hasHeroImage ? 'rgba(0,0,0,0.2)' : 'transparent',
              }}
            >
              📞 {phone}
            </a>
        ...
        {tenant.target_location && (
          <p
            ...
            style={{ color: hasHeroImage ? 'rgba(255,255,255,0.7)' : 'var(--brand-text)', opacity: hasHeroImage ? 1 : 0.5 }}
          >
