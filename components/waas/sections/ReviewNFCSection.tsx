...
export function ReviewNFCSection({
  tenant,
  config,
  content,
}: ReviewNFCSectionProps) {
    ...
    >
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-14">
          ...
          {content?.subheadline && (
            <p
              className="font-brand-body text-sm mb-3"
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <p className="font-brand-body text-white/70 text-lg max-w-xl mx-auto mb-8">
                Happy with our service? Tap our NFC card or scan the QR code to
                leave a quick review. It only takes 30 seconds and means the
                world to us.
              </p>
