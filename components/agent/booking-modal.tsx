...
export function BookingModal({
  ...
  const [selectedSlot, setSelectedSlot] =
    useState<CalendlyAvailableSlot | null>(null);
  ...
  async function loadSlots() {
    ...
    try {
      ...
      const endTime = new Date(
        startOfDay(selectedDate).getTime() + 24 * 60 * 60 * 1000,
      ).toISOString();
            ...
            {isLoadingEventTypes ? (
              ...
              <div className="text-center py-8">
                ...
                <p className="text-gray-400 text-xs mt-1">
                  Please contact us directly to schedule.
                </p>
              </div>
            ) : (
        ...
        {step === "confirm" && selectedEventType && (
          <div className="p-6">
            ...
            <p className="text-sm text-gray-600 mb-6">
              You'll be taken to our scheduling page to pick a time that works
              best for you.
            </p>
            <Button
        ...
        {step === "success" && (
          <div className="p-6 text-center">
            ...
            <p className="text-gray-500 text-sm mb-6">
              The scheduling page has been opened. Complete your booking there
