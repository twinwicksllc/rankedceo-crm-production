    ...
    <form onSubmit={handleSubmit} className="space-y-6">
      <div>
        ...
        <p className="mt-2 text-gray-600">
          Collaborate with your team members by inviting them to join your
          workspace
        </p>
      </div>
      ...
      <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
        <p className="text-sm text-blue-800">
          <strong>Note:</strong> Team members will receive an email invitation
          to join your workspace. You can always invite more people later from
          the settings page.
        </p>
      </div>
