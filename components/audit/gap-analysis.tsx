...
export function GapAnalysis({
  ...
  const insufficientRankingData =
    allGaps.length === 0 && measuredKeywords === 0 && evaluatedKeywords > 0;
    ...
    <div>
      ...
      >
        ...
        >
          ...
          />
          <StatBadge
            value={gapAnalysis.missingKeywords.length}
            label="Missing Keywords"
            color="#A78BFA"
            isLight={isLight}
          />
          <StatBadge
            value={gapAnalysis.opportunityScore}
      ...
      <div style={{ flex: 1 }}>
        ...
        >
          ...
          {type === "gap" && gap.yourRank && (
            ...
            >
              You: #{gap.yourRank} → {gap.competitorDomain}: #
              {gap.competitorRank}
            </span>
          )}
          {type === "missing" && (
  ...
  return (
    ...
    >
      ...
      <span
        style={{
          fontSize: "0.7rem",
          color: isLight ? "rgba(15,23,42,0.64)" : "rgba(255,255,255,0.56)",
        }}
      >
        {label}
      </span>
