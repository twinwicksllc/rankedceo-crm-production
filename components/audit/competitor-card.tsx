...
export function CompetitorCard({
  ...
  const isBeating =
    competitor.bestPosition !== null && competitor.bestPosition <= 10;
    ...
    >
      ...
      >
        ...
        <MetricBubble
          ...
          sub={
            !hasKeywordData
              ? "not enough SERP data"
              : isBeating
                ? "Beating you"
                : "Not a threat"
          }
          color={
            !hasKeywordData ? "#94A3B8" : isBeating ? "#EF4444" : "#22C55E"
          }
          isLight={isLight}
        />
      </div>
      ...
      {!hasKeywordData && (
        ...
        >
          Competitor keyword count is unavailable for this scan. This usually
          means no ranked competitor matches were found for the evaluated
          keyword set.
        </div>
      )}
      ...
      {isBeating && (
        ...
        >
          <span>⚠️</span>
          <span>
            <strong>{competitor.domain}</strong> ranks above {targetDomain} for
            key local search terms. They are actively stealing your leads.
          </span>
        </div>
      )}
    </div>
