    ...
    >
      {expired ? (
        <div style={{ textAlign: "center" }}>
          ...
          <div
            style={{
              fontSize: "0.78rem",
              color: isLight ? "rgba(15,23,42,0.55)" : "rgba(255,255,255,0.4)",
            }}
          >
      ...
      {!expired && critical && (
        ...
        >
          ...
          <strong>start your campaign</strong> to preserve these results
          permanently.
        </div>
      )}
    </div>
