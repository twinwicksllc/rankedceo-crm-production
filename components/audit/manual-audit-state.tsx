...
export function ManualAuditState({
  ...
  const message = subtitle ?? (
    <>
      ...
      <strong style={{ color: isLight ? "#B45309" : "#FCD34D" }}>
        {targetDomain}
      </strong>{" "}
      right now, but a RankedCEO strategist has already been notified and will
      complete your report manually.
    </>
  );
      ...
      >
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
          ...
          <NextStep
            ...
            description="We will review your site's rankings, speed, and competitor landscape manually."
            isLight={isLight}
          />
          <NextStep
            num={3}
          ...
          <NextStep
            num={4}
            title="Strategy Call"
            description="We will reach out to walk you through findings and recommend a growth plan."
            isLight={isLight}
          />
        </div>
      </div>
    ...
    >
      ...
      <div
        style={{
          ...
          color:
            valueColor ??
            (isLight ? "rgba(15,23,42,0.85)" : "rgba(255,255,255,0.8)"),
          textAlign: "right",
          wordBreak: "break-all",
        }}
      >
    ...
    <div style={{ display: "flex", gap: 12, alignItems: "flex-start" }}>
      ...
      <div>
        ...
        <div
          style={{
            fontSize: "0.76rem",
            color: isLight ? "rgba(15,23,42,0.65)" : "rgba(255,255,255,0.5)",
            lineHeight: 1.4,
          }}
        >
          {description}
