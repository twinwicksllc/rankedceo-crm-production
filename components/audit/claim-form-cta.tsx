...
export function ClaimFormCta({
  ...
  useEffect(() => {
    ...
    setCta(buildGetStartedUrl(getGetStartedBaseUrl(), searchParams, {
      tier: 'standard',
      auditId,
    }))
  }, [auditId])

  const isFormValid = form.name.trim() && form.email.trim() && isValidPhone(form.phone) && form.company.trim()
  ...
  return (
    <div
      style={{
        ...
        border: isLight ? '1px solid rgba(37,99,235,0.3)' : '1px solid rgba(37,99,235,0.35)',
        borderRadius: 16,
        overflow: 'hidden',
        boxShadow: isLight
    ...
    >
      ...
      {isUrgent && (
        ...
        >
          🚨 LIMITED SPOTS AVAILABLE — Claim yours now before onboarding closes for the month
        </div>
      )}
      ...
      <div style={{ padding: '28px 24px' }}>
        ...
        <div style={{ marginBottom: 24 }}>
          ...
          >
            ...
            , you qualify for a personalized website build + SEO strategy. Claim your spot now.
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} style={{ marginBottom: 20 }}>
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: 12 }}>
            ...
            <input
              ...
              onBlur={(e) => {
                (e.target as HTMLInputElement).style.borderColor = isLight ? '#e0e0e0' : 'rgba(255,255,255,0.15)'
              }}
          ...
          >
            {status === 'submitting' ? '⏳ Claiming your spot...' : '🎯 Claim My Free Website Review'}
          </button>
        </form>
