    ...
    <>
      ...
      >
        ...
        <div
          style={{
            background:
              "linear-gradient(135deg, rgba(37,99,235,0.15) 0%, rgba(0,0,0,0.4) 100%)",
            ...
            {PROGRESS_STEPS.map((step, i) => (
              <div
                ...
                style={{
                  ...
                  borderRadius: "50%",
                  background:
                    i <= stepIdx ? "#2563EB" : "rgba(255,255,255,0.12)",
        ...
        >
          This page refreshes automatically. Full audit typically takes 15–30
          seconds.
        </p>
      </div>
    </>
