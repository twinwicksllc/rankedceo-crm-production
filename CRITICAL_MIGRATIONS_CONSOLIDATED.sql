-- ============================================================================
-- CRITICAL MIGRATIONS CONSOLIDATED (FIXED VERSION)
-- ============================================================================
-- This file contains the 3 essential migrations needed for the application
-- to function properly. Apply this in Supabase SQL Editor.
-- FIXED: Handles missing stage column in deals table
-- ============================================================================

-- ============================================================================
-- MIGRATION 1: Commission Tracking (Phase 12)
-- File: 20240116000004_create_commissions.sql
-- FIXED: Adds stage column if missing, handles case-insensitive stage values
-- ============================================================================
...
-- File: 20240116000005_add_onboarding_fields.sql
-- ============================================================================
...
-- File: 20240116000006_add_update_company_info_function.sql
-- ============================================================================
...
-- MIGRATION COMPLETE
-- ============================================================================
-- All 3 critical migrations have been applied.
-- 
-- What was created/fixed:
-- 1. Added stage column to deals table (if missing)
-- 2. Commission tracking tables and triggers (case-insensitive stage matching)
-- 3. Onboarding fields in accounts table
-- 4. SECURITY DEFINER functions for onboarding
--
-- Next steps:
-- 1. Test commissions page at /commissions
-- 2. Test onboarding wizard at /onboarding
-- 3. Create a test deal and mark it as won to verify commission auto-creation
-- ============================================================================