...
1. **Hero**: "AI-Powered CRM for Service Businesses" + CTA buttons to /signup
2. **Problem/Solution**: Address lead management pain points
3. **Features Grid**: Show current features (contacts, deals, activities) + coming soon (AI scoring, campaigns)
4. **AI Spotlight**: Highlight Gemini AI lead scoring and Perplexity AI research
5. **Use Cases**: HVAC, plumbing, electrical, home services
6. **Security**: Enterprise encryption, multi-tenant, reCAPTCHA v3
7. **CTA**: "Start Free Trial" → /signup
...
**Use this prompt with any AI website builder (v0.dev, Lovable, Bolt, etc.) or share with a developer to create the landing page.**
