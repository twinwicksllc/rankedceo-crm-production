...
import { extractDomain, auditDebug, SERPER_TARGET_RESULTS, SerperOrganicResults, SerperSearchResult, SearchRankReport, RankResult } from './types'
...
// Barrel re-exports
export type { SerperSearchResult, SerperOrganicResults, RankResult, SearchRankReport } from './types'
export { extractDomain } from './types'
export { normalizeSerperLocation, inferGlFromLocation, normalizeTextTokens, parseLocationParts,
         keywordContainsLocation, stripLocationFromKeyword, buildQueryCandidates } from './location-utils'
