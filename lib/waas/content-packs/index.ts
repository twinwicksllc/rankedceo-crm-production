...
const GENERIC_FALLBACK: IndustryContentPack = {
  ...
  defaultServices: [
    { title: 'Residential Services',  description: 'Quality service for homes in the local area.',           icon: '🏠' },
    { title: 'Commercial Services',   description: 'Professional services for local businesses.',             icon: '🏢' },
    { title: 'Same-Day Availability', description: 'Prompt response for urgent and scheduled work.',          icon: '⚡' },
    { title: 'Free Estimates',        description: 'Transparent quotes with no obligation.',                  icon: '📋' },
    { title: 'Licensed & Insured',    description: 'Fully credentialed for your protection.',                 icon: '🛡️' },
    { title: 'Satisfaction Guarantee', description: 'We stand behind every job we do.',                      icon: '✅' },
  ],

  defaultFaqs: [
    {
      question: 'Are you licensed and insured?',
      answer:   'Yes — we carry all required licences and full liability insurance for every job.',
    },
    {
      question: 'How do I get a quote?',
      answer:   'Contact us for a free, no-obligation estimate. We provide clear pricing before any work begins.',
    },
    {
      question: 'How quickly can you start?',
      answer:   'We confirm availability quickly and can often start within 24–48 hours depending on the scope of work.',
    },
    {
      question: 'Do you offer a warranty on your work?',
      answer:   'Yes — all our work is backed by a workmanship warranty for your peace of mind.',
    },
  ],
  ...
  heroCopyPatterns: {
    standard: {
      ...
      subheadline: 'Reliable, professional service for homes and businesses — delivered with care and attention to detail.',
      ctaLabel:    'Get a Free Estimate',
    },
    emergency: {
      eyebrow:     '24/7 Emergency Service',
      headline:    'Urgent? We Respond Fast',
      subheadline: 'Emergency service available — call now and we\'ll have someone on the way.',
      ctaLabel:    'Call Now',
    },
    conversion: {
      eyebrow:     'Professional Service — Upfront Pricing',
      headline:    'Expert Help, No Hidden Costs',
      subheadline: 'Transparent quotes, qualified professionals, and guaranteed workmanship on every job.',
  ...
  seoKeywords: {
    ...
    midTail:        ['local service provider', 'professional near me', 'home services near me'],
    longTail:       ['best local service company near me', 'reliable service professional', 'licensed insured local professional'],
 ...
 */
export function getContentPack(trade: string | null | undefined): IndustryContentPack {
...
export type { IndustryContentPack, ServiceItem, FaqItem, HeroCopyPatterns, SeoKeywordCluster } from './types'
