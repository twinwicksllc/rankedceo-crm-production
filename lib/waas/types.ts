...
export type WaasPackageTier =
  "hosting_only" | "hosting" | "standard" | "premium";

export type WaasTenantStatus =
  "onboarding" | "pending_review" | "active" | "suspended" | "cancelled";

export type WaasAuditStatus =
...
export type UpdateWaasTenantInput = Partial<
  Omit<CreateWaasTenantInput, "slug">
> & {
  status?: WaasTenantStatus;
};
...
export const PACKAGE_TIER_FEATURES: Record<
  WaasPackageTier,
  {
    label: string;
    auditTool: boolean;
