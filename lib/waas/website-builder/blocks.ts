...
export const BLOCK_LIBRARY: BlockMeta[] = [
  { type: "hero",    label: "Hero",        description: "Eyebrow, title, subtitle & CTA" },
  ...
  switch (type) {
    case "hero":
      return {
        ...
        subtitle: "A clear, compelling subtitle that explains what your product does and why it matters.",
        buttonLabel: "Get started",
        align: "center",
      }
    case "heading":
      return { id: uid(type), type, text: "A section heading", level: "h2", align: "left" }
    case "text":
      return {
        id: uid(type),
        type,
    ...
    case "image":
      return { id: uid(type), type, src: "/placeholder.jpg", alt: "Placeholder image", rounded: true }
    case "button":
      return { id: uid(type), type, label: "Learn more", href: "#", variant: "solid", align: "left" }
    case "columns":
      return {
        id: uid(type),
        type,
