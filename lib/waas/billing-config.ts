...
export const WAAS_PLAN_PRICES_ENV_KEYS = {
  ...
  standard: {
    monthly: "WAAS_STRIPE_PRICE_STANDARD_MONTHLY",
    yearly: "WAAS_STRIPE_PRICE_STANDARD_YEARLY",
  },
  premium: {
    monthly: "WAAS_STRIPE_PRICE_PREMIUM_MONTHLY",
    yearly: "WAAS_STRIPE_PRICE_PREMIUM_YEARLY",
  },
} as const;
