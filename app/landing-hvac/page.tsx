      ...
      <header className="top-bar">
        ...
        >
          ...
          <div className="header-right">
            <p>
              Speak to a Specialist: <strong>(800) 555-0182</strong>
            </p>
          ...
          <div className="hero-content">
            <div className="hero-left">
              <div className="rating">
                ⭐ Rated &apos;Excellent&apos; | 1,200+ Verified Reviews
              </div>
              <h1>
                <span style={{ fontWeight: 400 }}>
                  Comfort You Can Count On
                </span>{" "}
                — <span style={{ fontWeight: 700 }}>Year Round</span>
              </h1>
              <h2>
                Affordable HVAC Service, Repairs & Installations Without the
                Surprise Bills
              </h2>
              <p className="hero-paragraph">
                HVAC Pro® connects you with a nationwide network of certified
                heating and cooling technicians offering member-only pricing on
                repairs, tune-ups, and full system replacements.
              </p>
              <ul>
            ...
            <div className="hero-right">
              <div className="testimonial" id="quote">
                ...
                <form method="POST" action="/api/landing/quote">
                  ...
                  <button type="submit" className="cta-button">
                    BOOK FREE HVAC CONSULTATION
                  </button>
                  <p className="form-disclaimer">
                    There is no cost. No obligation. Just clarity on your HVAC
                    options.
                  </p>
                </form>
              </div>
              ...
              <div className="testimonial-card">
                <p className="testimonial-text">
                  &ldquo;Our AC went out in July and HVAC Pro had a technician
                  at our door within 2 hours. Fixed same day, half the price I
                  expected. Incredible service.&rdquo;
                </p>
      ...
      <section className="proof-section">
        <div className="container">
          ...
          <p className="proof-subtitle">
            With over 8,000+ HVAC jobs completed, our certified technicians
            deliver fast, reliable service at prices that won&apos;t break the
            bank.
          </p>
          ...
          <p className="gallery-caption">
            ...
            <strong>Guaranteed Work. Unbeatable Prices.</strong>
          </p>
        </div>
      </section>
          ...
          <div className="two-column-grid">
            <div className="column">
              ...
              <ul className="bullet-list">
                <li>
                  Sweated through a summer because you couldn&apos;t afford AC
                  repair?
                </li>
                <li>Gotten a quote so high you just gave up?</li>
                <li>Waited days for a technician who never showed?</li>
                <li>
                  Been told your system needs full replacement when it just
                  needed a tune-up?
                </li>
              </ul>
              <p className="column-text">
                Traditional HVAC service can cost thousands with no transparency
                on pricing. Most homeowners delay repairs because of cost — not
                comfort.
              </p>
      ...
      <section className="bottom-cta-bar">
        <div className="container">
          <div className="cta-buttons-row">
            ...
            <a
              href="https://crm.rankedceo.com/pay?product=hvac-pro-monthly"
        ...
        <div className="container">
          <div className="footer-grid">
            <div className="footer-brand">
              ...
              <p>by Ranked CEO</p>
              <p className="desc">
                Connecting homeowners with certified HVAC technicians
                nationwide. Affordable, transparent pricing — no surprises.
              </p>
          ...
          <div className="footer-bottom">
            <p>
              © {new Date().getFullYear()} HVAC Pro by Ranked CEO. All rights
              reserved.
            </p>
