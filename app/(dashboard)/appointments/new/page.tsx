...
export default function NewAppointmentPage() {
  ...
  function handleOpenCalendly() {
    ...
    if (formData.invitee_name)
      url.searchParams.set("name", formData.invitee_name);
    if (formData.invitee_email)
      url.searchParams.set("email", formData.invitee_email);
      ...
      <div className="flex items-center gap-3 mb-8">
        ...
        <div>
          ...
          <p className="text-gray-500 text-sm mt-0.5">
            Book a call or meeting with a lead
          </p>
        </div>
      </div>
      ...
      {!isCalendlyConnected && !isLoadingEventTypes && (
        <div className="bg-amber-50 border border-amber-200 rounded-xl p-5 mb-6">
          ...
          <p className="text-sm text-amber-700 mb-3">
            Connect your Calendly account to enable smart scheduling with
          ...
          <div className="grid gap-4">
            <div className="space-y-1.5">
              ...
              <Input
                ...
                onChange={(e) =>
                  setFormData((p) => ({ ...p, invitee_name: e.target.value }))
                }
            ...
            <div className="space-y-1.5">
              ...
              <Input
                ...
                onChange={(e) =>
                  setFormData((p) => ({ ...p, invitee_email: e.target.value }))
                }
            ...
            <div className="space-y-1.5">
              ...
              <Input
                ...
                onChange={(e) =>
                  setFormData((p) => ({ ...p, invitee_phone: e.target.value }))
                }
