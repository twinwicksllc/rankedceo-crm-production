...
export default function ElectricalDashboard({
  ...
  const handleStatusChange = (leadId: string, newStatus: LeadStatus) => {
    ...
    getIndustryLeadStats("electrical").then((r) => {
        ...
        {emergencyLeads.length > 0 && (
          <div className="rounded-lg border border-red-300 bg-red-50 p-4">
            <p className="text-sm font-bold text-red-800 mb-3">
              🚨 {emergencyLeads.length} Electrical Emergency
              {emergencyLeads.length > 1 ? "s" : ""} — Safety Issue Reported
            </p>
          ...
          {loading ? (
            ...
            <div className="rounded-lg border border-dashed border-gray-300 bg-white p-12 text-center">
              ...
              <p className="text-sm text-gray-400 mt-1">
                Share your lead link to start capturing electrical service
                requests
              </p>
              <Button
