...
export default function ElectricalLoginPage() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (userIndustry && userIndustry !== "electrical") {
      ...
      console.error("[ElectricalLogin] Error:", err.message);
      ...
      <Card className="w-full max-w-md border-amber-200 shadow-lg">
        <CardHeader className="space-y-1 text-center">
          <div className="flex justify-center mb-4">
            <IndustryLogo industry="electrical" height={126} priority />
          </div>
        ...
        <CardContent>
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            ...
            >
              {loading ? "Signing in..." : "Sign In to Spark Pro"}
            </Button>
          </form>
        </CardContent>
        <CardFooter className="flex flex-col gap-2 text-center text-sm text-gray-500">
          ...
          <p className="text-xs text-gray-400">Spark Pro operators only.</p>
          <p className="text-xs text-gray-400">
            Wrong portal?{" "}
            <a
              href="https://smile.rankedceo.com"
            ...
            {" · "}
            <a
              href="https://plumbing.rankedceo.com"
