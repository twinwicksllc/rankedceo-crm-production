...
function AuditLoginForm() {
  ...
  if (magicSent) {
    return (
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(ellipse 65% 55% at 10% 0%, rgba(6,182,212,0.18) 0%, transparent 70%), radial-gradient(ellipse 65% 55% at 90% 30%, rgba(16,185,129,0.14) 0%, transparent 70%), #020b2c",
        }}
      >
  ...
  return (
    ...
    <div
      ...
      style={{
        background:
          "radial-gradient(ellipse 55% 45% at 0% 0%, rgba(6,182,212,0.2) 0%, transparent 65%), radial-gradient(ellipse 55% 45% at 100% 25%, rgba(16,185,129,0.15) 0%, transparent 65%), radial-gradient(ellipse 60% 55% at 50% 100%, rgba(29,78,216,0.22) 0%, transparent 65%), #020b2c",
      }}
    >
