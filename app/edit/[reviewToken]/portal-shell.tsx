...
export function PortalShell({
  ...
  const [historyOpenOnMount, setHistoryOpenOnMount] = useState(
    activeTab === "history",
  );
  ...
  return (
    <div
      ...
      data-testid="client-portal-root"
    >
      {/* ------------------------------------------------------------------ */}
      ...
      <header className="shrink-0 border-b border-slate-200 bg-white">
        ...
        <div className="flex items-center justify-between px-4 pt-3 pb-1">
          <div className="flex items-center gap-3 min-w-0 flex-1">
            ...
            {!session.approvalLocked &&
              !session.approvalAt &&
              portalData?.siteStatus &&
              !portalData.siteStatus.initialBuildCompletedAt && (
                <span className="inline-flex items-center gap-1 rounded-full bg-sky-50 border border-sky-200 px-2 py-0.5 text-[10px] font-medium text-sky-700">
                  <svg
                    className="h-2.5 w-2.5 text-sky-500 animate-spin"
            ...
            {!session.approvalLocked &&
              !session.approvalAt &&
              portalData?.siteStatus?.initialBuildCompletedAt &&
              portalData.siteStatus.aiEnhancementStatus === "in_progress" && (
      ...
      <div className="flex min-h-0 flex-1">
        ...
        {activeTab === "billing" && (
          <div
            data-testid="billing-tab-content"
            className="flex flex-1 min-h-0"
          >
            <BillingTab
              tenantId={session.tenantId}
