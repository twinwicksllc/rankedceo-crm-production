...
const PRODUCT_MAP: Record<
  string,
  { priceId: string; industry: string; interval: "monthly" | "yearly" }
> = {
  "hvac-pro-monthly": {
    priceId: STRIPE_PRICE_IDS.hvac.monthly,
    industry: "hvac",
    interval: "monthly",
  },
  "hvac-pro-yearly": {
    priceId: STRIPE_PRICE_IDS.hvac.yearly,
    industry: "hvac",
    interval: "yearly",
  },
  "plumbing-pro-monthly": {
    priceId: STRIPE_PRICE_IDS.plumbing.monthly,
    industry: "plumbing",
    interval: "monthly",
  },
  "plumbing-pro-yearly": {
    priceId: STRIPE_PRICE_IDS.plumbing.yearly,
    industry: "plumbing",
    interval: "yearly",
  },
  "electrical-pro-monthly": {
    priceId: STRIPE_PRICE_IDS.electrical.monthly,
    industry: "electrical",
    interval: "monthly",
  },
  "electrical-pro-yearly": {
    priceId: STRIPE_PRICE_IDS.electrical.yearly,
    industry: "electrical",
    interval: "yearly",
  },
  "smile-pro-monthly": {
    priceId: STRIPE_PRICE_IDS.smile.monthly,
    industry: "smile",
    interval: "monthly",
  },
  "smile-pro-yearly": {
    priceId: STRIPE_PRICE_IDS.smile.yearly,
    industry: "smile",
    interval: "yearly",
  },
};
...
export default async function PayPage({ searchParams }: PayPageProps) {
  ...
  const price =
    interval === "monthly" ? planInfo.monthlyPrice : planInfo.yearlyPrice;
  const savings =
    interval === "yearly"
      ? Math.round(
          ((planInfo.monthlyPrice * 12 - planInfo.yearlyPrice) /
            (planInfo.monthlyPrice * 12)) *
            100,
        )
      : 0;
