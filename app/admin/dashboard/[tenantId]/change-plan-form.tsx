...
export function ChangePlanForm({
  ...
  const [interval, setInterval] = useState<"month" | "year" | null>(
    currentInterval,
  );
  ...
  return (
    <div className="space-y-4">
      ...
      <div>
        ...
        {tier === "hosting_only" && (
          <p className="mt-1.5 text-teal-400 text-[10px]">
            ℹ️ Hosting Only is billed annually — interval will be set to
            &quot;year&quot; automatically.
          </p>
        )}
      </div>
      ...
      <p className="text-white/25 text-[10px]">
        This is a manual override — Stripe subscription is not modified. Use
        this for comped accounts, manual invoicing, or test tenants.
      </p>
